...
SECRET_KEY = "django-insecure-6e@27-&89)b26bqfj(en1l66r5qvklp+%=63)ryfkl42g(7rrm"
DEBUG = True
...
DEFAULT_FROM_EMAIL = 'noreply@smartshop.com'

# Frontend URLs (for email verification links)
FRONTEND_URL = 'http://localhost:3000'  # Change later to my frontend URL